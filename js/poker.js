...
// texas holdem poker: poker.js
// License: GPLv2
// (c) 2021 js-css-poker.sourceforge.io
...
function new_game_continues (req_no_opponents) {
	var my_players = [
		...
		new player("James", 0, "", "", "", 0, 0),
		new player("Catherine", 0, "", "", "", 0, 0),
		new player("Ralph", 0, "", "", "", 0, 0),
		new player("Freya", 0, "", "", "", 0, 0),
		new player("William", 0, "", "", "", 0, 0),
		new player("Jasmine", 0, "", "", "", 0, 0),
		new player("Tom", 0, "", "", "", 0, 0)
	 ];
